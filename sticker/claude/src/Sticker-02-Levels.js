...
let gameState = 'title';   // 'title' | 'playing' | 'won' | 'lost' | 'levelcomplete' | 'gamecomplete'
...
function draw() {
  ...
  if (gameState === 'title') {
    ...
    const sub = currentLevel < LEVELS.length - 1 ? `Press ENTER for Level ${nextLevelNum}` : 'Press ENTER for final level';
    drawBanner(msg, sub, color(180, 120, 240));
